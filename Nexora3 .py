...
st.markdown(
    ...
    * {
    ...
    .card:hover {
        ...
        border-color: rgba(139,156,255,.28);
        background:
            linear-gradient(
                145deg,
                rgba(255,255,255,.07),
    ...
    .metric-card:hover {
        border-color: rgba(139,156,255,.25);
    ...
    if submitted:
        ...
        if not name.strip() or not email.strip() or not message.strip():
            ...
            st.success(
                ...
                "The form is currently running in demo mode; connect "
                "it to your email or CRM backend before publishing."
            )
