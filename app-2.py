...
<script>
  ...
  // ---- App launch wiring ----
  // Set this to your deployed Streamlit app URL once it's live
  // (e.g. after deploying on Streamlit Community Cloud).
  // Leave empty ("") to keep the buttons inert until then.
  const APP_URL = "";

  document.querySelectorAll('.btn-primary, .price-btn').forEach(el => {
...
if not st.session_state.entered_app:
    ...
    if st.button("🚀 Enter the App", use_container_width=True, type="primary"):
