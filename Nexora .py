...
# ============================================================
# NEXORA — AI SYSTEMS & DIGITAL INTELLIGENCE
# Single-file Streamlit Company Website
# ============================================================
...
<style>
    ...
    * {
    ...
    .hero h1 .gradient {
        background: linear-gradient(100deg, #ffffff 10%, #9ca9ff 48%, #70d7ff 90%);
    ...
    .flagship {
        ...
        background:
            radial-gradient(circle at 80% 10%, rgba(100,116,255,.13), transparent 35%),
    ...
    .acquisition {
        background:
            linear-gradient(135deg, rgba(139,156,255,.10), rgba(0,0,0,.05));
        border: 1px solid rgba(139,156,255,.28);
        border-radius: 24px;
        padding: 42px;
    }
...
<div class="nexora-header">
    ...
    <div class="header-badge">AI Systems • Digital Intelligence</div>
</div>
""", unsafe_allow_html=True)
...
<div class="eyebrow">AI Systems & Digital Intelligence</div>

<h1>
Build smarter.<br>
<span class="gradient">Operate intelligently.</span>
</h1>

<div class="hero-copy">
Nexora builds AI-powered business systems, intelligent software products,
and custom digital solutions designed to help organizations analyze,
decide, automate, and execute with greater intelligence.
</div>
...
<div class="section">
    ...
    <div class="section-copy">
        We combine artificial intelligence, software engineering, business
        intelligence, automation, and strategic system design to create
        practical technology for modern businesses.
    </div>
</div>
""", unsafe_allow_html=True)
...
<div class="flagship-tag">Nexora Proprietary Technology</div>

<h2>AI Business Operating System™</h2>

<p>
An integrated business intelligence and decision-support system designed
to help organizations understand their business environment, evaluate
opportunities, analyze customers and competitors, assess financial and
operational factors, and turn analysis into structured strategic action.
</p>
...
<div class="section">
    ...
    <div class="section-copy">
        The platform is designed as a modular business intelligence and
        decision-support environment rather than a single-purpose AI tool.
    </div>
</div>
""", unsafe_allow_html=True)
...
process = [
    ("01", "Understand", "Capture business context, objectives, constraints, and available evidence."),
    ("02", "Investigate", "Organize relevant business, market, customer, competitor, and financial intelligence."),
    ("03", "Analyze", "Evaluate the available information through structured analytical frameworks."),
    ("04", "Validate", "Challenge assumptions, identify missing information, and stress-test conclusions."),
    ("05", "Decide", "Produce structured recommendations and decision-ready outputs."),
    ("06", "Execute", "Translate decisions into prioritized execution plans and measurable actions."),
]
...
<div class="section">
    ...
    <div class="section-copy">
        ...
        that need technology designed around their own workflows and requirements.
    </div>
</div>
""", unsafe_allow_html=True)
...
business_models = [
    ("Custom Projects", "Build systems for individual client requirements."),
    ("Ready-Made Products", "Sell proprietary systems developed by Nexora."),
    ("SaaS", "Offer products through recurring subscriptions."),
    ("Enterprise Licensing", "License technology to organizations."),
    ("IP Acquisition", "Transfer complete ownership of selected technology assets."),
]
...
for col, (title, text) in zip(cols, business_models):
    with col:
        ...
        <div class="metric-card">
            <div class="metric-value" style="font-size:1.05rem;">{title}</div>
...
<p>
Nexora is open to discussing a strategic acquisition of the AI Business
Operating System™ with a qualified technology company, enterprise software
provider, AI organization, consulting group, or strategic investor.
</p>

<p>
The contemplated transaction can include the complete software source code,
associated intellectual property, documentation, deployment materials, and
exclusive commercial ownership rights, subject to definitive agreements
and due diligence.
</p>
...
with cols[0]:
    st.markdown("""
    <div class="price-box">
        <div class="price-label">Initial Asking Position</div>
        <div class="price">$150,000</div>
        <div class="small-note">USD · subject to negotiation and due diligence</div>
    </div>
    """, unsafe_allow_html=True)
...
with cols[1]:
    st.markdown("""
    <div class="price-box">
        <div class="price-label">Transaction Scope</div>
        <div class="price">Full IP</div>
        <div class="small-note">Source code + proprietary technology + ownership</div>
    </div>
    """, unsafe_allow_html=True)
...
with cols[2]:
    st.markdown("""
    <div class="price-box">
        <div class="price-label">Disclosure Model</div>
        <div class="price">NDA First</div>
        <div class="small-note">Detailed technical information provided during diligence</div>
    </div>
    """, unsafe_allow_html=True)
...
<div class="section">
    ...
    <div class="section-title">See the system in action.</div>
    <div class="section-copy">
        The production OS can be connected here as an interactive application
        or controlled demonstration environment.
    </div>
</div>
""", unsafe_allow_html=True)

with st.expander("Open Demonstration Preview"):
    st.info(
        "This section is intentionally prepared as the connection point for "
        "the live AI Business Operating System. Replace this preview with the "
        "production OS interface or a secure demo environment."
    )

    demo_question = st.text_area(
        "Example business question",
        placeholder="Example: Evaluate whether this business should enter a new market.",
        height=110
    )

    if st.button("Run Demo Preview"):
        if demo_question.strip():
            st.success(
                "Demo request captured. Connect this interface to the production "
                "AI Business Operating System to generate the real analysis."
            )
        else:
...
for i, item in enumerate(tech_items):
    with cols[i % 4]:
        ...
        <div class="card" style="margin-bottom:18px; padding:20px;">
            <p style="margin:0; color:#d2d8e4;">✓ {item}</p>
        </div>
        """, unsafe_allow_html=True)
...
<div class="section">
    ...
    <div class="section-copy">
        Nexora is being developed around a simple idea: businesses should be
        able to access sophisticated technology without having to assemble
...
<p>
Nexora combines custom software development with proprietary product
development. The company is designed to serve organizations that need
technology tailored to their specific business problems while also building
reusable AI products that can operate independently at scale.
</p>

<p>
Our long-term focus is on practical artificial intelligence: systems that
help businesses understand information, make better decisions, automate
work, and execute more effectively.
</p>
...
<p>
For custom software projects, enterprise AI solutions, product partnerships,
or the strategic acquisition opportunity, contact Nexora.
</p>
...
with st.form("contact_form"):
    ...
    if submitted:
        if not name or not email or not message:
            st.warning("Please complete your name, email, and message.")
        else:
            st.success(
                "Thank you. Your inquiry has been prepared successfully. "
                "Connect this form to your preferred email/form backend before "
...
<div>
<strong style="color:#dce2ec;">NEXORA</strong><br>
...
<strong>Important:</strong> Product capabilities, commercial terms,
valuation, ownership, and acquisition information are subject to verification,
